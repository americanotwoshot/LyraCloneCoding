...
/** BP를 통한 UFunction으로 바인딩하는 Delegate: DYNAMIC 필수 */
 ...
 */
UCLASS()
class LYRACLONECODING_API UAsyncAction_ExperienceReady : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
public:
